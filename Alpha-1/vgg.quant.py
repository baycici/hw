...
cfg = {
    ...
    'VGG16_quant_project': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 8, 'S', 512, 'M', 512, 512, 512, 'M'],
    'VGG16_quant_project_alpha': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 16, 'S', 512, 'M', 512, 512, 512, 'M'],
...
def VGG16_quant_project(**kwargs):
    model = VGG_quant(vgg_name = 'VGG16_quant_project', **kwargs)
    return model
def VGG16_quant_project_alpha(**kwargs):
    model = VGG_quant(vgg_name = 'VGG16_quant_project_alpha', **kwargs)
    return model
